    ...
    const handleClick = (e) => {
        ...
        if (
            ...
            const payload = {
                ...
                subscription_type: 'content_moderation'
            };
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-5" data-aos="fade-up" data-aos-duration="1200">
                                <div class="font-montserrat text-wrapper">
                                    <h3 class="fs-50 fw-600 font-montserrat">Content Moderation</h3>
                            ...
                            <div class="col-lg-7" data-aos="fade-up" data-aos-duration="1200">
                                <div class="d-flex align-items-center justify-content-center">
                                    ...
                                    <img src="assets/img/illustrations/Content_moderation_2.svg" alt="Image" class="animate-float-bob-y" />
                                </div>
                            </div>
                        </div>
                    </div>
