                        ...
                        <div class="col-lg-6 col-md-8 wow fadeInUp">
                            <div class="consultation-form-area pl-xl-3 content-mt-md-50">
                                <div class="consultation-form">
                                    <h3 class="title">Content Moderation </h3>
                ...
                <div class="container">
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-lg-6 col-md-8 color-white-70">
                            <h1 style={{ color: "white", marginBottom: "20px" }}>Content Moderation</h1>
                            <p>
                            Today, content comes in many structures and forms. It can be in the form of a text, picture, blogs, articles, comments, recordings or even live videos. At Taskmo, we offer highly specialised content moderation services that will help maintain a positive image of your brand online. Being the best content moderation service provider, the content moderators and content specialists work on any volume of content and format of content and contribute towards bringing in a flawless image of your organisation. The content moderators and content specialists at Taskmo work on vetting, moderating, scrutinizing and scanning all types of content based on predefined principles and rules. We work flexibly and seamlessly work towards providing the highest quality of work.
                            </p> 
                        </div>
                    </div>
                </div>
                                ...
                                <div class="accordion accordion-bordered" id="accordionFaqOne">
                                    <div class="accordion-item accordion-active">
                                        ...
                                        <div id="accordion-1" class="collapse show" data-parent="#accordionFaqOne">
                                            ...
                                            At Taskmo we offer all types of content moderation services that include comments, images, videos, social media and so much more. You can outsource your content moderation services of any volume to Taskmo and we’ll help you   detect content issues such as spam, abuse, defamation, copyright infringements, offense, plagiarism, profanity, nudity, pornography, or quality issues.
                                            </div>
                                        </div>
                                    </div>
