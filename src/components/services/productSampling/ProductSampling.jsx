        ...
        const handleClick = (e) => {
            ...
            if (
                ...
                const payload = {
                    ...
                    subscription_type: 'ProductSampling'
                };
                        ...
                        <div class="row align-items-center justify-content-center">
                            <div class="col-lg-6 col-md-10">
                                <div class="feature-img text-lg-left text-center content-mb-md-50">
                                    <img src="assets/img/illustrations/productsampling_image.svg" alt="Image" />
                                </div>
                            </div>
                            <div class="font-montserrat col-lg-6 col-md-8 wow fadeInUp">
                                <div class="consultation-form-area pl-xl-3 content-mt-md-50">
                                    <div class="consultation-form">
                                        <h3 class="title font-montserrat fw-600">Product Sampling</h3>
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-5" data-aos="fade-up" data-aos-duration="1200">
                                    <div class="font-montserrat text-wrapper">
                                        <h3 class="fs-50 fw-600 font-montserrat">Product Sampling</h3>
                                ...
                                <div class="col-lg-7" data-aos="fade-up" data-aos-duration="1200">
                                    <div class="d-flex align-items-center justify-content-center">
                                        ...
                                        <img src="assets/img/illustrations/Productsampling_img1.svg" alt="Image" class="animate-float-bob-y" />
                                    </div>
                                </div>
                            </div>
                        </div>
