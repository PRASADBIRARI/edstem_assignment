                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-9 col-lg-11 col-md-10 m-auto">
                                <h6>Contact us</h6>
                                <h2>Leverage Your Business With Us!</h2>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 col-sm-6 d-lg-flex">
                                <div class="address-info">
                                    ...
                                    <p class="font-rubik">#33, Mohan chambers, 1st Main Rd, 3rd Phase, J. P. Nagar, Bengaluru, Karnataka, 560078.</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-6 d-lg-flex">
                                <div class="address-info">
                                    ...
                                    <p class="font-rubik">business@taskmo.com <br />+91 8448449069</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-6 d-lg-flex">
                                <div class="address-info">
                    ...
                    <div class="form-style-classic mt-150 md-mt-80">
                        <form action="#" id="contact-form" action="inc/contact.php" data-toggle="validator">
                            ...
                            <div class="row controls">
                                ...
                                <div class="col-12" data-aos="fade-up" data-aos-duration="1200"><button class="theme-btn-six lg">Send Message</button></div>
                            </div>
                        </form>
                    </div>
                </div>
