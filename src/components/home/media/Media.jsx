...
export default function LeftButton(props) {
    ...
    return (
        <section class="centerAlign" style={{ paddingBottom: "100px" }}>
            {/* <p style={{ paddingBottom: "30px" }}>PRESS</p> */}

            <div class="section-heading text-center mb-30">
                <h2 class="title">Latest Media Features and Awards</h2>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6" data-aos="fade-right">
                            <div class="block-style-twentySix text-center mb-40" style={{background:"#E8FBFF"}}>
                                <h6 style={{color:"#8BBDC8"}}>The Economic Times</h6>
                                <h4>More women go big on gig during Covid pandemic, better jobs now available</h4>
                                <a href="#" class="try-btn" style={{borderColor:"#C0E9F2"}}>Read More</a>
                        ...
                        <div class="col-md-6" data-aos="fade-left">
                            <div class="block-style-twentySix text-center mb-40" style={{background:"#FFEFE7"}}>
                                <h6 style={{color:"#DCAC91"}}>Times Of India</h6>
                                <h4>How an auto-ride inspired two IT professionals to start a jobs platform.</h4>
                                <a href="#" class="try-btn" style={{borderColor:"#F5D1BD"}}>Read More</a>
